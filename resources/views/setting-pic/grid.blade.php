        ...
        <div class="card card-flush mb-5 mb-xl-10" id="kt_profile_details_view">
            <div class="card-header">
                <div class="d-flex flex-column card-title m-0 py-5">
                    <h3 class="fw-bolder m-0">Setting PIC</h3>
                    <div class="text-gray-400 fw-bold fs-5 py-2 text-xs">
                        Pengaturan PIC aplikasi Key Performance Indikator
                    </div>
                </div>
        ...
        <div class="row" id="list-time">
            ...
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2021')">2021</p>
                    <div class="row mx-0">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Tahun Pengaturan PIC</h5>
...
<script src="{{asset('assets/extends/js/page/setting-pic.js')}}"></script>
