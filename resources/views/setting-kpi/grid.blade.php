...
<div class="post d-flex flex-column-fluid" id="kt_post">
    <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card-header">
                <div class="d-flex flex-column card-title m-0 py-5">
                    ...
                    <div class="text-gray-400 fw-bold fs-5 py-2 text-xs">
                        Pengaturan RAKP Korporat aplikasi Key Performance Indikator
                    </div>
                </div>
        ...
        <div class="row" id="list-time">
            <div class="col-md-3 px-2" style="width:20%;cursor:pointer;" onclick="create()">
                <div class="text-center setting-item rounded p-4 text-success bg-light-success" style="border:1px dashed #4CAF50">
                    ...
                    <h5 class="mb-0 mt-4 text-success">Tambah Data</h5>
            ...
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2022')">2022</p>
                    <div class="row mx-0">
                        <div class="col-md-6 text-center py-3 px-6">
                            <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                <input class="form-check-input h-20px w-30px" type="checkbox" value="" id="flexSwitch20x30" checked/>
                            </div>
                        </div>
        ...
        <div class="row d-none" id="list-time-unit-create">
            <div class="col-md-3 px-2" style="width:20%;cursor:pointer;" onclick="create()">
                <div class="text-center setting-item rounded p-4 text-success bg-light-success" style="border:1px dashed #4CAF50">
                    <span class="svg-icon svg-icon-success svg-icon-4x">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2022')">2022</p>
                    <span class="badge badge-secondary fs-8 me-4">Menunggu Approval</span>
                </div>
            </div>
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2022')">2022</p>
                    <span class="badge badge-light-success fs-7 me-4">Selesai</span>
                </div>
            </div>
        </div>
        <div class="row d-none" id="list-time-unit-returned">
            <div class="col-md-3 px-2" style="width:20%;cursor:pointer;" onclick="create()">
                <div class="text-center setting-item rounded p-4 text-success bg-light-success" style="border:1px dashed #4CAF50">
                    <span class="svg-icon svg-icon-success svg-icon-4x">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2022')">2022</p>
                    <span class="badge badge-light-danger fs-7 me-4">Dikembalikan</span>
                </div>
            </div>
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
        ...
        <div class="row d-none" id="list-time-direksi">
            <div class="col-md-3 px-2" style="width:20%;cursor:pointer;" onclick="create()">
                <div class="text-center setting-item rounded p-4 text-success bg-light-success" style="border:1px dashed #4CAF50">
                    <span class="svg-icon svg-icon-success svg-icon-4x">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
                    <p class="text-dark fw-bolder mb-0" id="title-1" style="font-size:3rem;cursor:pointer;"  onclick="detail('1','2022')">2022</p>
                    <span class="badge badge-danger fs-7 me-4">Perlu Approval</span>
                </div>
            </div>
            <div class="col-md-3 px-2" style="width:20%;">
                <div class=" text-center setting-item border rounded p-4" style="background-color:#fff;height:100%">
