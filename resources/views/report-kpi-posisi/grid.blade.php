                ...
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label mt-5">Report KPI Posisi</span>
                            <span class="text-muted mt-2 fw-bold fs-7">Menu Cetak KPI Posisi pada aplikasi Key Performance Indicator</span>
                        </h3>
                    </div>
                    <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 text-right">
                                        <a href="{{ asset('report/kpi-posisi/preview') }}" class="btn btn-light-success">Preview</a>
                                    </div>
                                    <div class="col-sm-6 text-right">
