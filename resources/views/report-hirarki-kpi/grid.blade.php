                ...
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label mt-5">Report Hirarki KPI</span>
                            <span class="text-muted mt-2 fw-bold fs-7">Menu Cetak hirarki KPI pada aplikasi Key Performance Indicator</span>
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="container col-md-5">
                            <form>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <fieldset disabled>
                                            <input type="text" id="" class="form-control" placeholder="PDF">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 text-right">
                                        <a href="{{ asset('report/hirarki-kpi/preview') }}" class="btn btn-light-success">Preview</a>
                                    </div>
                                    <div class="col-sm-6 text-right">
