                ...
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label mt-5">Report Ringkasan Prespektif</span>
                            <span class="text-muted mt-2 fw-bold fs-7">Menu Cetak Ringkasan/Catatan setiap prespektif pada aplikasi Key Performance Indicator</span>
                        </h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active menu-form" id="kt_widget_tab_1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 text-right">
                                            <a href="{{ asset('report/ringkasan-prespektif/preview') }}" class="btn btn-light-success">Preview</a>
                                        </div>
                                        <div class="col-sm-6 text-right">
                                ...
                                <div class="tab-pane fade menu-form" id="kt_widget_tab_2">
                                    ...
                                    <div class="form-group row mb-8">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="tahun2" placeholder="Pilih tahun">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-8">
