    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div id="detail-kpi" class="row">
            <div class="col-lg-3 mb-10">
                <div class="card card-flush h-lg-80">
                    ...
                    <div class="card-body">
                        <div class="mb-10">
                            <span class="fw-bolder fs-1">Departemen Legal</span>
                        </div>
                        <h4 class="fw-bolder mb-3">Status KPI</h4>
                        <div class="row">
                            <div class="col-5 mb-3 border border-gray-300 border-dashed rounded py-3 px-1 me-2 mb-0">
                            ...
                            <div class="col-5 border border-gray-300 border-dashed rounded py-3 px-1 me-2 mb-0">
                                <div class="fs-2 fw-bolder text-info">12</div>
                                <div class="fw-bold fs-8 text-gray-400">Waiting</div>
                            </div>
                            <div class="col-5 border border-gray-300 border-dashed rounded py-3 px-1 me-2 mb-0">
                                <div class="fs-2 fw-bolder text-success">84</div>
