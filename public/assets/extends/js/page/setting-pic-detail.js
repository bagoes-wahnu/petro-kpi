...
jQuery(document).ready(function($) {
    $("#nav-setting-pic").addClass("active");
...
function tambahPIC(){
    ...
    <input type="hidden" name="targets[]" value="`+uuid+`"/>
        ...
        <div class="col-8 mb-10 ps-0">
            ...
            <select class="form-select select_parameter" data-control="select2" name="lbl-parameter" id="parameter-`+uuid1+`" data-placeholder="Pilih parameter">
            </select>
        </div>
